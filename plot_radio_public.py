...
scores_dict = json_data["microsoft/phi-2"]["PublicAveragedScore"]
...
scores_dict = json_data["meta-llama/Meta-Llama-3-8B"]["PublicAveragedScore"]

data2 = np.array([scores_dict["cs"], scores_dict["fin"], scores_dict["math"], scores_dict["econ"],
                   scores_dict["eess"], scores_dict["physics"], scores_dict["stat"], scores_dict["q-bio"]])*100

scores_dict = json_data["nvidia/Llama-3.1-Nemotron-70B-Instruct-HF"]["PublicAveragedScore"]

data3 = np.array([scores_dict["cs"], scores_dict["fin"], scores_dict["math"], scores_dict["econ"],
                   scores_dict["eess"], scores_dict["physics"], scores_dict["stat"], scores_dict["q-bio"]])*100

scores_dict = json_data["EleutherAI/gpt-j-6B"]["PublicAveragedScore"]

data4 = np.array([scores_dict["cs"], scores_dict["fin"], scores_dict["math"], scores_dict["econ"],
                   scores_dict["eess"], scores_dict["physics"], scores_dict["stat"], scores_dict["q-bio"]])*100

scores_dict = json_data["01-ai/Yi-1.5-34B-Chat"]["PublicAveragedScore"]
...
data_20=np.array([20,20,20,20,20,20,20,20])
data_40=np.array([40,40,40,40,40,40,40,40])
data_60=np.array([60,60,60,60,60,60,60,60])
data_80=np.array([80,80,80,80,80,80,80,80])
data_100=np.array([100,100,100,100,100,100,100,100])
